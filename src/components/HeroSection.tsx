    ...
    <div className='h-screen w-full flex items-center justify-center'>
      ...
      />    
        <div className='p-4 text-center w-full'>
            <h1 className='mt-20 md:mt-10 text-4xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400'>Master the art of music</h1>
